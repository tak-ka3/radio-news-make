...
def main(input,gpu='0',is_exclude_end=True,is_tokens=False):
    ...
    with tf.Session(config=config, graph=tf.Graph()) as sess:
        ...
        ckpt = tf.train.latest_checkpoint(model_)
        ...
        for text in texts:
            ...
            scores.append(sum(logprobs_list))
        return scores